...
Namespace Business
    Public Class Diem_BLL
        ...
        ''
        Private dsDiemThiChiTiet As BLL.DiemThiChiTiet_BLL
        ''
#Region "Constructor"
        Sub New()
        ...
        Sub New(ByVal ID_he As Integer, ByVal ID_dv As String, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_mon As Integer, ByVal dsID_lop As String, ByVal dtDanhSachSinhVien As DataTable, Optional ByVal PhongThi As Boolean = False, Optional ByVal Chon_mac_dinh_tp As Boolean = False, Optional ByVal Lan_hoc As Integer = 1, Optional ByVal ID_dt As Integer = 0)
            ...
            If PhongThi Then
                ...
                If dsID_sv <> "" Then
                    ...
                    dsDiemThiChiTiet = New BLL.DiemThiChiTiet_BLL(dsID_lop, Hoc_ky, Nam_hoc, dsID_sv, ID_mon)
                End If
            Else
        ...
        'Load điểm để tổng hợp học kỳ, năm học và toàn khoá theo môn nghề hay môn văn hóa
        Sub New(ByVal ID_he As Integer, ByVal ID_dv As String, ByVal ID_bm_chinh As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal dsID_lop As String, ByVal dsID_dt As String, ByVal dtDanhSachSinhVien As DataTable, ByVal isMonVanHoa As Boolean, Optional ByVal Ky_thu As Integer = 0)
            mID_dv = ID_dv
            mdtDanhSachSinhVien = dtDanhSachSinhVien
            'Khởi tạo quy chế
            ...
            Load_MonHocTrongDiem_TongHop(ID_dv, dsID_lop, ID_bm_chinh, isMonVanHoa, Hoc_ky, Nam_hoc, 0, dsID_dt, Ky_thu)
...
#Region "Property"
        ...
        Public Function GetDiemThiChiTiet() As BLL.DiemThiChiTiet_BLL
            Return Me.dsDiemThiChiTiet
        End Function

#End Region
#Region "Function"
        Public Function GetDsThanhPhanThi() As Generic.List(Of ThanhPhanThi)
            Return Me.dsDiemThiChiTiet.dsThanhPhanThi
        End Function
        Private Function ConvertDiem(ByVal dr As DataRow) As Diem
            ...
            objDiem.So_tiet_th = IIf(IsDBNull(dr("Thuc_hanh")), 0, dr("Thuc_hanh"))
            Return objDiem
        End Function
        Private Function ConvertDiemDanh(ByVal dr As DataRow) As DiemDanh
            ...
            If dr.Item("So_tiet_nghi").ToString <> "" Then objDiemDanh.So_tiet_nghi = dr.Item("So_tiet_nghi")
            If dr.Item("So_tiet_nghi_th").ToString <> "" Then objDiemDanh.So_tiet_nghi_th = dr.Item("So_tiet_nghi_th")
        ...
        Private Function ConvertDiemThi(ByVal dr As DataRow) As DiemThi
            ...
            If dr.Table.Columns.Contains("ID_diem_thi") Then
                objDiemThi.ID_diem_thi = IIf(IsNumeric(dr("ID_diem_thi")), dr("ID_diem_thi"), 0)
            End If
            Return objDiemThi
        End Function
        Private Sub Load_Diem(ByVal ID_dv As String, ByVal dsID_lop As String, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "", Optional ByVal dsID_sv As String = "", Optional ByVal ID_mon As Integer = 0, Optional ByVal dsID_dt As String = "")
            ...
            If dtDiem.Rows.Count > 0 Then
                For idx_diem As Integer = 0 To dtDiem.Rows.Count - 1
                    If dtDiem.Rows(idx_diem)("ID_sv") = 66462 Then
                        dtDiem.Rows(idx_diem)("ID_sv") = 66462
                    End If
                    Try
...
Add_diem:
        ...
        Private Sub Load_MonHocTrongCTDT(ByVal dsID_dt As String, ByVal ID_bm_chinh As Integer)
            ...
            For i As Integer = 0 To dtMon.Rows.Count - 1
                ...
                objCTDT.Ly_thuyet_nghe = dtMon.Rows(i)("Ly_thuyet_nghe")
                objCTDT.Thuc_hanh_nghe = dtMon.Rows(i)("Thuc_hanh_nghe")
        ...
        Private Sub Load_MonHocTrongDiem(ByVal ID_dv As String, ByVal dsID_lop As String, ByVal ID_bm_chinh As Integer, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "", Optional ByVal ID_sv As Integer = 0, Optional ByVal dsID_dt As String = "")
            ...
            Next
        End Sub
        Private Sub Load_MonHocTrongDiem_TongHop(ByVal ID_dv As String, ByVal dsID_lop As String, ByVal ID_bm_chinh As Integer, ByVal isMonVanHoa As Boolean, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "", Optional ByVal ID_sv As Integer = 0, Optional ByVal dsID_dt As String = "", Optional ByVal Ky_thu As Integer = 0)
            Dim dtMon As DataTable
            Dim clsDAL As New ChuongTrinhDaoTao_DAL
            Dim fAdd As Boolean = False
            'Load các học phần thuộc các chương trình đào tạo
            ...
            For i As Integer = 0 To dtMon.Rows.Count - 1
                '' Môn văn hóa được set Kien_thuc = 30
                If (dtMon.Rows(i)("Kien_thuc").ToString() = "30" And isMonVanHoa) _
                Or (dtMon.Rows(i)("Kien_thuc").ToString() <> "30" And Not isMonVanHoa) Then
                    Dim objCTDT As New ChuongTrinhDaoTaoChiTiet
                    'Kiểm tra xem có trùng môn không?
                    fAdd = True
                    For j As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If fAdd Then
                        ...
                        objCTDT.Khong_tinh_TBCHT = dtMon.Rows(i)("Khong_tinh_TBCHT")
                        objCTDT.Mon_thi_TN = dtMon.Rows(i)("Mon_tot_nghiep")
                        objCTDT.Kien_thuc = dtMon.Rows(i)("Kien_thuc")

                        objCTDT.Ly_thuyet = dtMon.Rows(i)("Ly_thuyet")
                        objCTDT.Bai_tap = dtMon.Rows(i)("Bai_tap")
                        objCTDT.Bai_tap_lon = dtMon.Rows(i)("Bai_tap_lon")
                        objCTDT.Thuc_tap = dtMon.Rows(i)("Thuc_tap")
                        objCTDT.Thuc_hanh = dtMon.Rows(i)("Thuc_hanh")
                        objCTDT.Thuc_hanh_nghe = dtMon.Rows(i)("Thuc_hanh_nghe")
                        objCTDT.Ly_thuyet_nghe = dtMon.Rows(i)("Ly_thuyet_nghe")
                        dsMonHoc.Add(objCTDT)
                    End If
        ...
        Private Sub Load_ThanhPhanMon(ByVal ID_dv As String, ByVal ID_he As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_mon As Integer, ByVal dsID_lop As String, ByVal Chon_mac_dinh_tp As Boolean, Optional ByVal Lan_hoc As Integer = 1)
        ...
        Public Function DanhSachDiemThiLan1(ByVal ID_mon As Integer, ByVal Lan_hoc As Integer) As DataTable
            ...
            For i As Integer = 0 To dsThanhPhanDiem.Count - 1
                ...
                End If
            Next
            ''Thêm các thành phần thi

            For index As Integer = 0 To Me.dsDiemThiChiTiet.dsThanhPhanThi.Count - 1
                If Not dtDiem.Columns.Contains("Thi." & Me.dsDiemThiChiTiet.dsThanhPhanThi(index).ID_thanh_phan) Then
                    dtDiem.Columns.Add("Thi." & Me.dsDiemThiChiTiet.dsThanhPhanThi(index).ID_thanh_phan, GetType(Double))
                End If
            Next
            ''
            ...
            For Each dr In dtDiem.Rows
                idx = Tim_idx(dr("ID_sv"), ID_mon, dr("ID_dt"))
                dr("Locked") = 0
                dr("idx_diem") = -1
                dr("idx_diem_thi") = -1
                If idx >= 0 Then
                    ...
                    If idx_mon >= 0 Then
                        ...
                        For i As Integer = 0 To dsThanhPhanDiem.Count - 1
                            ...
                            End If
                        Next
                        'Gán các điểm thi chi tiết
                        For i As Integer = 0 To Me.dsDiemThiChiTiet.dsDiemThiChiTiet.Count - 1
                            If objDiem.dsDiemThi.Count > 0 AndAlso Me.dsDiemThiChiTiet.dsDiemThiChiTiet(i).ID_diem_thi = objDiem.dsDiemThi.DiemThi(0).ID_diem_thi Then
                                ID_thanh_phan = Me.dsDiemThiChiTiet.dsDiemThiChiTiet(i).ThanhPhanThi.ID_thanh_phan
                                Dim Diem_thi_ct As Double = Me.dsDiemThiChiTiet.dsDiemThiChiTiet(i).Diem
                                If dr.Table.Columns.Contains("Thi." & ID_thanh_phan.ToString()) Then
                                    dr.Item("Thi." & ID_thanh_phan.ToString()) = Math.Round(Diem_thi_ct, 1, MidpointRounding.AwayFromZero)
                                End If
                            End If
                        Next
                    End If
                    ...
                    If objDiem.dsDiemThi.Count > 0 Then objDiem.dsDiemThi.DiemThi(0).Diem_thi = Diem_thi
        ...
        Function Doc_so(ByVal str As String) As String
            Select Case str
                Case "0" : Return "Không"
                Case "0.0" : Return "Không"
                Case "0.1" : Return "Không phẩy một"
                Case "0.2" : Return "Không phẩy hai"
                Case "0.3" : Return "Không phẩy ba"
                Case "0.4" : Return "Không phẩy bốn"
                Case "0.5" : Return "Không phẩy năm"
                Case "0.6" : Return "Không phẩy sáu"
                Case "0.7" : Return "Không phẩy bảy"
                Case "0.8" : Return "Không phẩy tám"
                Case "0.9" : Return "Không phẩy chín"

                Case "1" : Return "Một tròn"
                Case "1.0" : Return "Một tròn"
                Case "1.1" : Return "Một phẩy một"
                Case "1.2" : Return "Một phẩy hai"
                Case "1.3" : Return "Một phẩy ba"
                Case "1.4" : Return "Một phẩy bốn"
                Case "1.5" : Return "Một phẩy năm"
                Case "1.6" : Return "Một phẩy sáu"
                Case "1.7" : Return "Một phẩy bảy"
                Case "1.8" : Return "Một phẩy tám"
                Case "1.9" : Return "Một phẩy chín"

                Case "2" : Return "Hai tròn"
                Case "2.0" : Return "Hai tròn"
                Case "2.1" : Return "Hai phẩy một"
                Case "2.2" : Return "Hai phẩy hai"
                Case "2.3" : Return "Hai phẩy ba"
                Case "2.4" : Return "Hai phẩy bốn"
                Case "2.5" : Return "Hai phẩy năm"
                Case "2.6" : Return "Hai phẩy sáu"
                Case "2.7" : Return "Hai phẩy bảy"
                Case "2.8" : Return "Hai phẩy tám"
                Case "2.9" : Return "Hai phẩy chín"

                Case "3" : Return "Ba tròn"
                Case "3.0" : Return "Ba tròn"
                Case "3.1" : Return "Ba phẩy một"
                Case "3.2" : Return "Ba phẩy hai"
                Case "3.3" : Return "Ba phẩy ba"
                Case "3.4" : Return "Ba phẩy bốn"
                Case "3.5" : Return "Ba phẩy năm"
                Case "3.6" : Return "Ba phẩy sáu"
                Case "3.7" : Return "Ba phẩy bảy"
                Case "3.8" : Return "Ba phẩy tám"
                Case "3.9" : Return "Ba phẩy chín"

                Case "4" : Return "Bốn tròn"
                Case "4.0" : Return "Bốn tròn"
                Case "4.1" : Return "Bốn phẩy một"
                Case "4.2" : Return "Bốn phẩy hai"
                Case "4.3" : Return "Bốn phẩy ba"
                Case "4.4" : Return "Bốn phẩy bốn"
                Case "4.5" : Return "Bốn phẩy năm"
                Case "4.6" : Return "Bốn phẩy sáu"
                Case "4.7" : Return "Bốn phẩy bảy"
                Case "4.8" : Return "Bốn phẩy tám"
                Case "4.9" : Return "Bốn phẩy chín"

                Case "5" : Return "Năm tròn"
                Case "5.0" : Return "Năm tròn"
                Case "5.1" : Return "Năm phẩy một"
                Case "5.2" : Return "Năm phẩy hai"
                Case "5.3" : Return "Năm phẩy ba"
                Case "5.4" : Return "Năm phẩy bốn"
                Case "5.5" : Return "Năm phẩy năm"
                Case "5.6" : Return "Năm phẩy sáu"
                Case "5.7" : Return "Năm phẩy bảy"
                Case "5.8" : Return "Năm phẩy tám"
                Case "5.9" : Return "Năm phẩy chín"

                Case "6" : Return "Sáu tròn"
                Case "6.0" : Return "Sáu tròn"
                Case "6.1" : Return "Sáu phẩy một"
                Case "6.2" : Return "Sáu phẩy hai"
                Case "6.3" : Return "Sáu phẩy ba"
                Case "6.4" : Return "Sáu phẩy bốn"
                Case "6.5" : Return "Sáu phẩy năm"
                Case "6.6" : Return "Sáu phẩy sáu"
                Case "6.7" : Return "Sáu phẩy bảy"
                Case "6.8" : Return "Sáu phẩy tám"
                Case "6.9" : Return "Sáu phẩy chín"

                Case "7" : Return "Bẩy tròn"
                Case "7.0" : Return "Bẩy tròn"
                Case "7.1" : Return "Bẩy phẩy một"
                Case "7.2" : Return "Bẩy phẩy hai"
                Case "7.3" : Return "Bẩy phẩy ba"
                Case "7.4" : Return "Bẩy phẩy bốn"
                Case "7.5" : Return "Bẩy phẩy năm"
                Case "7.6" : Return "Bẩy phẩy sáu"
                Case "7.7" : Return "Bẩy phẩy bảy"
                Case "7.8" : Return "Bẩy phẩy tám"
                Case "7.9" : Return "Bẩy phẩy chín"

                Case "8" : Return "Tám tròn"
                Case "8.0" : Return "Tám tròn"
                Case "8.1" : Return "Tám phẩy một"
                Case "8.2" : Return "Tám phẩy hai"
                Case "8.3" : Return "Tám phẩy ba"
                Case "8.4" : Return "Tám phẩy bốn"
                Case "8.5" : Return "Tám phẩy năm"
                Case "8.6" : Return "Tám phẩy sáu"
                Case "8.7" : Return "Tám phẩy bảy"
                Case "8.8" : Return "Tám phẩy tám"
                Case "8.9" : Return "Tám phẩy chín"

                Case "9" : Return "Chín tròn"
                Case "9.0" : Return "Chín tròn"
                Case "9.1" : Return "Chín phẩy một"
                Case "9.2" : Return "Chín phẩy hai"
                Case "9.3" : Return "Chín phẩy ba"
                Case "9.4" : Return "Chín phẩy bốn"
                Case "9.5" : Return "Chín phẩy năm"
                Case "9.6" : Return "Chín phẩy sáu"
                Case "9.7" : Return "Chín phẩy bảy"
                Case "9.8" : Return "Chín phẩy tám"
                Case "9.9" : Return "Chín phẩy chín"

                Case "10" : Return "Mười tròn"
                Case "10.0" : Return "Mười tròn"
            End Select
        End Function
            ...
            For Each dr In dtDiem.Rows
                ...
                If idx >= 0 Then
                    ...
                    If Diem_thi >= 0 Then
                        ...
                        dr("Diem_chu") = Doc_so(Convert.ToString(Math.Round(Diem_thi + 0.0000000001, 1)))
                    Else
                    ...
                    If objDiem.dsDiemThi.Ghi_chu_lan(Lan_hoc, 1).ToString <> "" Then dr.Item("Ghi_chu") = "Cấm thi"
                    dr.Item("Locked") = objDiem.dsDiemThi.Diem_thi_lan_Locked(Lan_hoc, 1)
                End If
            Next
            Return dtDiem
        ...
        Public Function DanhSachDiemThiLan(ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer, ByVal ID_mon As Integer, ByVal Check_diem_lan1 As Boolean) As DataTable
            ...
            For i As Integer = dtDiem.Rows.Count - 1 To 0 Step -1
                ...
                End If
                idx = Tim_idx(dtDiem.Rows(i)("ID_sv"), ID_mon, dtDiem.Rows(i)("ID_dt"))
                'idx = Tim_idx(271597, 4211)
                ...
                If idx >= 0 Then
                    ...
                    If objDiem.Check_hien_thi(Lan_hoc, Lan_thi) Then
                        If idx_mon >= 0 Then
                            'Gán các điểm thành phần vào cột điểm
        ...
        Public Function DanhSachDiemThanhPhan(ByVal ID_mon As Integer, ByVal Lan_hoc As Integer, Optional ByVal So_hoc_trinh As Integer = 0) As DataTable
            ...
            For i As Integer = 0 To dsThanhPhanDiem.Count - 1
                If So_hoc_trinh > 0 Then
                    If i >= So_hoc_trinh AndAlso dsThanhPhanDiem.ThanhPhanDiem(i).Chuyencan = False Then
            ...
            dtDiemTP.Columns.Add("So_tiet_nghi_th", GetType(Integer))
            ...
            For r As Integer = dtDiemTP.Rows.Count - 1 To 0 Step -1
                idx = Tim_idx(dtDiemTP.Rows(r)("ID_sv"), ID_mon, dtDiemTP.Rows(r)("ID_dt"))
                If idx >= 0 Then
                    'Lấy 1 Object điểm
                    Dim objDiem As Diem = CType(arrDiem(idx), Diem)
                    ...
                    If (Lan_hoc = 1) Or (Lan_hoc > 1 AndAlso objDiem.Check_hien_thi(Lan_hoc)) Then
                        ...
                        If (idx >= 0) Then
                            ...
                            'Thêm số tiết nghỉ thực hành
                            'by anhnt
                            If objDiem.dsDiemDanh.DiemDanh(idx).So_tiet_nghi_th > 0 Then dtDiemTP.Rows(r)("So_tiet_nghi_th") = objDiem.dsDiemDanh.DiemDanh(idx).So_tiet_nghi_th
        ...
        Public Function DanhSachThanhPhanChon() As DataTable
            ...
            Return dtTP
        End Function
        Public Function DanhSachMonHoc_KhongTinhTBCHT() As DataTable
        ...
        Public Function DanhSachMonTotNghiep() As DataTable
            Dim dtMonHoc As New DataTable
            Dim Tong_ty_le As Integer = 0
            dtMonHoc.Columns.Add("ID_mon", GetType(Integer))
            dtMonHoc.Columns.Add("Ky_hieu", GetType(String))
        ...
        Function PhanLoaiHocTap_Mon(ByVal dt_kqht As DataTable) As DataTable
            ...
            Return dt
        End Function
        Public Function TongHopDiemHocKy(ByVal Lan_thi As Byte, ByVal Hien_thi_ghi_chu As Boolean, ByVal Hien_thi_diem_TP As Boolean, Optional ByVal dtDiem_RL As DataTable = Nothing, Optional ByVal Loc_diem_TBCHT As Boolean = False, Optional ByVal Tu_diem As Double = 0, Optional ByVal Den_diem As Double = 0, Optional ByVal Diem_5 As Boolean = False, Optional ByVal TBCMH_5 As Boolean = False) As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem, Tong_diem1, Tong_diem2 As Double, Tong_so_hoc_trinh As Double
            Dim TBCHT, TBCHT1, TBCHT2, TBCHP, TBCHP1, TBCHP2, So_trinh_no, Diem_thi_l1, Diem_thi_l2, Diem_thi_max As Double
            Dim So_mon_hoc_lai As Integer, So_mon_thi_lai, So_mon_no As Integer
            Dim Ghi_chu_thi As String = ""
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            dtTongHop.Columns.Add("TBCHT1", GetType(Double))
            ...
            dtTongHop.Columns.Add("Ten_mon_no", GetType(String))
            dtTongHop.Columns.Add("So_trinh_no", GetType(Double))

            dtTongHop.Columns.Add("So_mon_thi_lai", GetType(Integer))
            dtTongHop.Columns.Add("Ten_mon_thi_lai", GetType(String))

            dtTongHop.Columns.Add("So_mon_hoc_lai", GetType(Integer))
            dtTongHop.Columns.Add("Ten_mon_hoc_lai", GetType(String))

            dtTongHop.Columns.Add("Ly_do", GetType(String))
            dtTongHop.Columns.Add("TBC_RL", GetType(Double))
            dtTongHop.Columns.Add("ID_Xep_loai_RL", GetType(String))
            dtTongHop.Columns.Add("Xep_loai_RL", GetType(String))
            'Gan cac diem chi tiet tung mon hoc cua sinh vien va tinh diem TBCHT, Xep Loai
            For Each dr In dtTongHop.Rows
                So_mon_no = 0
                So_trinh_no = 0
                Dim Ten_mon_no As String = ""

                Tong_diem = 0
                Tong_diem1 = 0
                Tong_so_hoc_trinh = 0
                So_mon_thi_lai = 0
                Dim Ten_mon_thi_lai As String = ""

                So_mon_hoc_lai = 0
                Dim Ten_mon_hoc_lai As String = ""
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        ...
                        TBCHP2 = (diem.dsDiemThi.TBCHP_lan(1, 2))
                        TBCHP = ((diem.dsDiemThi.TBCHP_max))

                        Diem_thi_l1 = (diem.dsDiemThi.Diem_thi_lan(1, 1))
                        Diem_thi_l2 = (diem.dsDiemThi.Diem_thi_lan(1, 2))
                        Diem_thi_max = ((diem.dsDiemThi.Diem_thi_max))
                        If Lan_thi = 1 Then
                            Ghi_chu_thi = Right(diem.dsDiemThi.Diem_thi_lan1_view(True), 3)
                        Else
                            Ghi_chu_thi = Right(diem.dsDiemThi.Diem_thi_lan_cac_lan_view(True), 3)
                        End If
                        If TBCHP1 >= 0 And Not Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT And Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = False And Ghi_chu_thi <> "(M)" Then
                            Tong_diem1 = (Tong_diem1 + (TBCHP1 * Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh))
                            Tong_diem2 = (Tong_diem2 + (TBCHP2 * Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh))
                        ...
                        If Hien_thi_diem_TP Then
                            ...
                            End If
                            If (Lan_thi = 1) Then
                                If Ghi_chu_thi.ToString <> "" And Hien_thi_ghi_chu Then
                                    dr.Item(("T" & ID_mon.ToString & "Thi")) = diem.dsDiemThi.Diem_thi_lan1_view(Hien_thi_ghi_chu) & Ghi_chu_thi.ToString
                                Else
                                    dr.Item(("T" & ID_mon.ToString & "Thi")) = diem.dsDiemThi.Diem_thi_lan1_view(Hien_thi_ghi_chu)
                                End If
                            Else
                                If Ghi_chu_thi.ToString <> "" And Hien_thi_ghi_chu Then
                                    dr.Item(("T" & ID_mon.ToString & "Thi")) = diem.dsDiemThi.Diem_thi_lan_cac_lan_view(Hien_thi_ghi_chu) & Ghi_chu_thi.ToString
                                Else
                        ...
                        If TBCHP1 >= 0 Then
                            If (Lan_thi = 1) Then
                                If Ghi_chu_thi.ToString = "(M)" Then
                                    dr.Item(("M" & ID_mon.ToString)) = "M"
                                Else
                                    If Ghi_chu_thi.ToString <> "" And Hien_thi_ghi_chu Then
                                        dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP1, QC.TBCHP_lam_tron).ToString & Ghi_chu_thi.ToString
                                    Else
                                        dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP1, QC.TBCHP_lam_tron).ToString
                                    End If
                                End If
                            Else
                                If Ghi_chu_thi.ToString = "M" Then
                                ...
                                Else
                                    If Ghi_chu_thi.ToString <> "" And Hien_thi_ghi_chu Then
                                        dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP, QC.TBCHP_lam_tron).ToString & Ghi_chu_thi.ToString
                                    Else
                                        dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP, QC.TBCHP_lam_tron).ToString
                                    End If
                                End If
                            End If
                        End If

                        If Ghi_chu_thi.ToString = "(K)" Then
                            So_mon_hoc_lai += 1
                            Ten_mon_hoc_lai += ", " & (i + 1)
                        End If
                        If Lan_thi = 1 Then
                            If (Diem_thi_l1 >= 0 And Diem_thi_l1 < 5) Or (TBCHP1 >= 0 And TBCHP1 < 5 And Ghi_chu_thi <> "(M)") And Ghi_chu_thi <> "(K)" Then
                                So_mon_no += 1
                                So_trinh_no = (So_trinh_no + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                                Ten_mon_no += ", " & (i + 1)
                            End If
                        Else
                            If (Diem_thi_max >= 0 And Diem_thi_max < 5) Or (TBCHP >= 0 And TBCHP < 5 And Ghi_chu_thi <> "(M)") Then
                                So_mon_no += 1
                                So_trinh_no = (So_trinh_no + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                                Ten_mon_no += ", " & (i + 1)
                            End If
                        ...
                        If Lan_thi = 1 Then
                            If Ghi_chu_thi <> "(M)" And Ghi_chu_thi <> "(K)" Then
                                If Diem_thi_l1 >= 0 And Diem_thi_l1 < QC.Diem_hoc_phan_dat Then
                                    Ten_mon_thi_lai += ", " & (i + 1)
                                    So_mon_thi_lai += 1
                                End If
                            End If
                        Else
                            If TBCHP >= 0 And TBCHP < QC.Diem_hoc_phan_dat Then
                                If Diem_thi_max >= 0 And Diem_thi_max < QC.Diem_hoc_phan_dat And Ghi_chu_thi <> "(M)" And Ghi_chu_thi <> "(K)" Then
                                    Ten_mon_thi_lai += ", " & (i + 1)
                                    So_mon_thi_lai += 1
                                End If
                            End If
                    ...
                    End If
                Next
                ' Tính điểm rèn luyện và xếp loại
                For k As Integer = 0 To dtDiem_RL.Rows.Count - 1
                    If dtDiem_RL.Rows(k).Item("ID_SV") = dr("ID_sv") Then
                        TongDiemRL = dtDiem_RL.Rows(k).Item("Tong_diem")
                        XepLoai_RL = dtDiem_RL.Rows(k).Item("Xep_loai")
                        ID_XepLoai_RL = dtDiem_RL.Rows(k).Item("ID_Xep_loai")
                    End If
                Next
                dr.Item("TBC_RL") = TongDiemRL
                dr.Item("ID_Xep_loai_RL") = ID_XepLoai_RL
                dr.Item("Xep_loai_RL") = XepLoai_RL
                'Tính điểm TBCHT và xếp loại
                If (Tong_so_hoc_trinh > 0) Then
                    TBCHT1 = Math.Round((Tong_diem1 / Tong_so_hoc_trinh) + 0.000001, QC.TBCHT_lam_tron)
                    TBCHT2 = Math.Round((Tong_diem2 / Tong_so_hoc_trinh) + 0.000001, QC.TBCHT_lam_tron)
                    TBCHT = Math.Round((Tong_diem / Tong_so_hoc_trinh) + 0.00000001, QC.TBCHT_lam_tron)

                    Dim objXepLoai As New XepLoaiHocTap
                    Dim Phan_tram_thi_lai As Integer = So_mon_thi_lai / dsMonHoc.Count

                    If Lan_thi = 1 Then
                        dr.Item("TBCHT") = Math.Round(TBCHT1 + 0.000000001, QC.TBCHT_lam_tron)
                    ...
                    Else
                        dr.Item("TBCHT") = Math.Round(TBCHT + 0.00000001, QC.TBCHT_lam_tron)
                ...
                Else
                    dr.Item("So_mon_no") = 0
                End If
                If Ten_mon_no.Length > 2 Then
                    dr.Item("Ten_mon_no") = Ten_mon_no.Substring(2)
                Else
                    dr.Item("Ten_mon_no") = "'"
                End If
                If (So_trinh_no > 0) Then
                    dr.Item("So_trinh_no") = So_trinh_no
                Else
                    dr.Item("So_trinh_no") = 0
                End If

                If (So_mon_hoc_lai > 0) Then
                    dr.Item("So_mon_hoc_lai") = So_mon_hoc_lai
                Else
                    dr.Item("So_mon_hoc_lai") = 0
                End If
                If Ten_mon_hoc_lai.Length > 2 Then
                    dr.Item("Ten_mon_hoc_lai") = Ten_mon_hoc_lai.Substring(2)
                Else
                    dr.Item("Ten_mon_hoc_lai") = ""
                End If
                If (So_mon_thi_lai > 0) Then
                    dr.Item("So_mon_thi_lai") = So_mon_thi_lai
                Else
                    dr.Item("So_mon_thi_lai") = 0
                End If
                If Ten_mon_thi_lai.Length > 2 Then
                    dr.Item("Ten_mon_thi_lai") = Ten_mon_thi_lai.Substring(2)
                Else
                    dr.Item("Ten_mon_thi_lai") = ""
                End If
            Next
            Dim dkFill As String = " AND 1=1"
            Dim dv As DataView = dtTongHop.DefaultView
            Dim strFillter As String = "1=1"

            If Loc_diem_TBCHT Then strFillter += " AND TBCHT>=" & Tu_diem & " AND TBCHT<=" & Den_diem
            If Diem_5 Then strFillter += " AND So_mon_thi_duoi5<1"
            If TBCMH_5 Then strFillter += " AND So_mon_thi_lai<1"
            strFillter += dkFill
        ...
        'dtTongHop.Columns.Add("Xep_loai", GetType(String))
        'dtTongHop.Columns.Add("So_mon_no", GetType(Integer))
        'dtTongHop.Columns.Add("So_trinh_no", GetType(Integer))
        ...
        'Return dtTongHop
        'End Function
        Public Function TongHopDiemHocTapNam(ByVal Lan_thi As Byte, ByVal Hien_thi_ghi_chu As Boolean, ByVal Hien_thi_diem_TP As Boolean, Optional ByVal dtDiem_RL As DataTable = Nothing, Optional ByVal Loc_diem_TBCHT As Boolean = False, Optional ByVal Tu_diem As Double = 0, Optional ByVal Den_diem As Double = 0, Optional ByVal Diem_5 As Boolean = False, Optional ByVal TBCMH_5 As Boolean = False) As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem, Tong_diem1, Tong_diem2 As Double, Tong_so_hoc_trinh As Double
            Dim TBCHT, TBCHT1, TBCHT2, TBCHP, TBCHP1, TBCHP2, So_trinh_no, Diem_thi_l1, Diem_thi_l2, Diem_thi_max As Double
            Dim So_mon_hoc_lai As Integer, So_mon_thi_lai, So_mon_no, So_mon_thi_duoi5 As Integer
            Dim Ghi_chu_thi As String = ""
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            dtTongHop.Columns.Add("TBCHT1", GetType(Double))
            ...
            dtTongHop.Columns.Add("So_trinh_no", GetType(Double))
            dtTongHop.Columns.Add("Ten_mon_no", GetType(String))
            dtTongHop.Columns.Add("So_mon_thi_duoi5", GetType(Integer))
            dtTongHop.Columns.Add("Ten_mon_thi_duoi5", GetType(String))
            ...
            For Each dr In dtTongHop.Rows
                ...
                So_mon_thi_duoi5 = 0
                Dim Ten_mon_no As String = ""
                Dim Ten_mon_thi_duoi5 As String = ""
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        ...
                        Diem_thi_max = ((diem.dsDiemThi.Diem_thi_max))
                        If Lan_thi = 1 Then
                            'Ghi_chu_thi = diem.dsDiemThi.Ghi_chu
                            Ghi_chu_thi = Right(diem.dsDiemThi.Diem_thi_lan1_view(True), 3)
                        Else
                            Ghi_chu_thi = Right(diem.dsDiemThi.Diem_thi_lan_cac_lan_view(True), 3)
                        End If
                        ...
                        If TBCHP1 >= 0 Then
                            If (Lan_thi = 1) Then
                                'If TBCHP <> TBCHP1 Then
                                '    dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP1, QC.TBCHP_lam_tron).ToString + " - " + QC.FormatSoThapPhan(TBCHP, QC.TBCHP_lam_tron).ToString
                                'Else
                                If Ghi_chu_thi.ToString = "(M)" Then
                                    dr.Item(("M" & ID_mon.ToString)) = "M"
                                Else
                        ...
                        If Diem_thi_max >= 0 And (Diem_thi_max < 5) And Ghi_chu_thi <> "(M)" Then
                            So_mon_no += 1
                        End If
                        If Lan_thi = 1 Then
                            If (Diem_thi_l1 >= 0 And Diem_thi_l1 < 5) Or (TBCHP1 >= 0 And TBCHP1 < 5 And Ghi_chu_thi <> "(M)") Then
                                So_trinh_no = (So_trinh_no + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                                Ten_mon_no += ", " & (i + 1)
                                So_mon_thi_lai += 1
                            End If
                        ...
                        If Lan_thi = 1 Then
                            If Diem_thi_l1 >= 0 And Diem_thi_l1 < QC.Diem_hoc_phan_dat And Ghi_chu_thi <> "(M)" Then
                                Ten_mon_thi_duoi5 += ", " & (i + 1)
                                So_mon_thi_duoi5 += 1
                            End If
                        Else
                            If TBCHP >= 0 And TBCHP < QC.Diem_hoc_phan_dat And Ghi_chu_thi <> "(M)" Then
                                If Diem_thi_max >= 0 And Diem_thi_max < QC.Diem_hoc_phan_dat And Ghi_chu_thi <> "(M)" Then
                                    Ten_mon_thi_duoi5 += ", " & (i + 1)
                                    So_mon_thi_duoi5 += 1
                                End If
                            End If
                ...
                If (So_mon_thi_duoi5 > 0) Then
                    dr.Item("So_mon_thi_duoi5") = So_mon_thi_duoi5
                Else
                    dr.Item("So_mon_thi_duoi5") = 0
                End If
                If Ten_mon_thi_duoi5.Length > 2 Then
                    dr.Item("Ten_mon_thi_duoi5") = Ten_mon_thi_duoi5.Substring(2)
                Else
                    dr.Item("Ten_mon_thi_duoi5") = ""
                End If
            Next
            Dim dkFill As String = " AND 1=1"
            Dim dv As DataView = dtTongHop.DefaultView
        ...
        Public Function TongHopDiemHocTapToanKhoa(ByVal Hien_thi_ghi_chu As Boolean, ByVal Lan_thi As Integer, ByVal Hien_thi_diem_TP As Boolean) As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem, Tong_diem1 As Double, Tong_so_hoc_trinh As Integer
            Dim TBCHT, TBCHT1, TBCHP, TBCHP1, Diem_thi1, Diem_thi_max As Double
            Dim So_mon_hoc_lai As Integer, So_mon_thi_lai, So_mon_no As Integer
            Dim Ly_thuyet, Thuc_hanh, Bai_tap, Bai_tap_lon, Thuc_tap, Tong_tiet, So_trinh_thi_lai As Double
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            dtTongHop.Columns.Add("TBCHT1", GetType(Double))
            dtTongHop.Columns.Add("TBCHT", GetType(Double))
            ...
            dtTongHop.Columns.Add("So_trinh_no", GetType(Integer))
            dtTongHop.Columns.Add("So_mon_thi_lai", GetType(Integer))
            dtTongHop.Columns.Add("So_trinh_thi_lai", GetType(Integer))
            dtTongHop.Columns.Add("So_mon_hoc_lai", GetType(Integer))
            dtTongHop.Columns.Add("Ly_do", GetType(String))
            dtTongHop.Columns.Add("Tong_tiet", GetType(Double))
            dtTongHop.Columns.Add("Ten_mon_no", GetType(String))
            'Gan cac diem chi tiet tung mon hoc cua sinh vien va tinh diem TBCHT, Xep Loai
            For Each dr In dtTongHop.Rows
                So_mon_no = 0
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        Dim diem As Diem = arrDiem(idx_diem)
                        Diem_thi1 = diem.dsDiemThi.Diem_thi_lan(1, 1)
                        Diem_thi_max = diem.dsDiemThi.Diem_thi_max

                        TBCHP1 = Math.Round(diem.dsDiemThi.TBCHP_lan(1, 1), QC.TBCHP_lam_tron)
                        TBCHP = Math.Round(diem.dsDiemThi.TBCHP_max, QC.TBCHP_lam_tron)
                        If (TBCHP1 >= 0) And Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = False And Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT = False Then
                            Tong_diem1 = (Tong_diem1 + (TBCHP1 * Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh))
                            Tong_diem = (Tong_diem + (TBCHP * Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh))
                            Tong_so_hoc_trinh = (Tong_so_hoc_trinh + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                        End If
                        ...
                        Else
                            If TBCHP1 >= 0 Then
                                If TBCHP1 <> TBCHP Then
                                    dr.Item(("M" & ID_mon.ToString)) = QC.FormatSoThapPhan(TBCHP1, QC.TBCHP_lam_tron) & " - " & QC.FormatSoThapPhan(TBCHP, QC.TBCHP_lam_tron)
                                Else
                        ...
                        If (Lan_thi = 1) Then
                            If ((Diem_thi1 >= 0 And Diem_thi1 < QC.Diem_hoc_phan_dat) Or (TBCHP1 > 0 And TBCHP1 < QC.Diem_hoc_phan_dat)) Then
                                So_mon_no += 1
                                Ly_thuyet = (Ly_thuyet + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ly_thuyet)
                                Thuc_hanh = (Thuc_hanh + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_hanh)
                                Bai_tap = (Bai_tap + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Bai_tap)
                                Bai_tap_lon = (Bai_tap_lon + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Bai_tap_lon)
                                Thuc_tap = (Thuc_tap + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_tap)
                                Tong_tiet = Ly_thuyet + Thuc_hanh + Bai_tap + Bai_tap_lon + Thuc_tap
                            End If
                        Else
                            If ((Diem_thi_max >= 0 And Diem_thi_max < QC.Diem_hoc_phan_dat) Or (TBCHP > 0 And TBCHP < QC.Diem_hoc_phan_dat)) Then
                                So_mon_no += 1
                                Ly_thuyet = (Ly_thuyet + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ly_thuyet)
                                Thuc_hanh = (Thuc_hanh + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_hanh)
                                Bai_tap = (Bai_tap + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Bai_tap)
                ...
                If (Tong_so_hoc_trinh > 0) Then
                    ...
                    Dim Phan_tram_thi_lai As Integer = So_mon_thi_lai / dsMonHoc.Count
                    If Lan_thi = 1 Then
                        objXepLoai = QC.Xep_loai_hoc_tap(dsXepLoaiHocTap, TBCHT)
                    Else
                        objXepLoai = QC.Xep_loai_hoc_tap(dsXepLoaiHocTap, TBCHT1)
                    End If
                    dr.Item("ID_xep_loai") = objXepLoai.ID_xep_loai
                    dr.Item("Xep_loai") = objXepLoai.Xep_loai
                    dr.Item("Ly_do") = objXepLoai.Ghi_chu
                ...
                If (So_trinh_no > 0) Then
                    dr.Item("So_trinh_no") = So_trinh_no
                End If
                If (So_trinh_thi_lai > 0) Then
                    dr.Item("So_trinh_thi_lai") = So_trinh_thi_lai
                End If

                If (Tong_tiet >= 0) Then
                    dr.Item("Tong_tiet") = Tong_tiet
                End If
                If Ten_mon_no.Length > 2 Then
                    dr.Item("Ten_mon_no") = Ten_mon_no.Substring(2)
                End If
        ...
        Public Function TongHopMonThiTotNghiep(ByVal Hien_thi_ghi_chu As Boolean, ByVal Lan_thi As Integer, ByVal Hien_thi_diem_TP As Boolean) As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem, Tong_diem1 As Double, Tong_so_hoc_trinh As Integer
            Dim TBCHT, TBCHT1, TBCHP, TBCHP1, Diem_thi1, Diem_thi_max, DiemCT, Diem_TH, Diem_LT As Double
            Dim So_mon_hoc_lai As Integer, So_mon_thi_lai, So_mon_no As Integer
            Dim Ly_thuyet, Thuc_hanh, Bai_tap, Bai_tap_lon, Thuc_tap, Tong_tiet As Double
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            'dtTongHop.Columns.Add("TBCHT1", GetType(Double))
            'dtTongHop.Columns.Add("TBCHT", GetType(Double))
            ...
            dtTongHop.Columns.Add("Tong_tiet", GetType(Double))
            dtTongHop.Columns.Add("Ten_mon_no", GetType(String))
            dtTongHop.Columns.Add("TBCTN", GetType(Double))
            'Gan cac diem chi tiet tung mon hoc cua sinh vien va tinh diem TBCHT, Xep Loai
            For Each dr In dtTongHop.Rows
                So_mon_no = 0
                Tong_diem = 0
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        ...
                        If ((TBCHP1 >= 0) And Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN) Then
                            If Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_hanh_nghe Then
                                Diem_TH = TBCHP * 2
                            ElseIf Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ly_thuyet_nghe Then
                                Diem_LT = TBCHP * 1
                            End If
                        End If
                        '---------Add column----------------
                ...
                If Ten_mon_no.Length > 2 Then
                    dr.Item("Ten_mon_no") = Ten_mon_no.Substring(2)
                End If
                dr("TBCTN") = Math.Round(((Diem_LT + Diem_TH) / 3) + 0.000001, QC.TBCHP_lam_tron)
            Next
            Return dtTongHop
        End Function

        Public Function XetLenLop(Optional ByVal Lan_thi As Integer = 0) As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem As Double, Tong_so_hoc_trinh As Double
            Dim TBCHT, TBCHP, So_trinh_no, Diem_thi_max As Double
            Dim So_mon_hoc_lai As Integer, So_mon_thi_lai, So_mon_no As Integer
            Dim Ly_thuyet, Thuc_hanh, Bai_tap, Bai_tap_lon, Thuc_tap, Tong_tiet As Double
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            ...
            dtTongHop.Columns.Add("Ly_do", GetType(String))
            dtTongHop.Columns.Add("So_trinh_no", GetType(Double))
            dtTongHop.Columns.Add("Tong_tiet", GetType(Integer))
            dtTongHop.Columns.Add("Ten_mon_no", GetType(String))
            'Gan cac diem chi tiet tung mon hoc cua sinh vien va tinh diem TBCHT, Xep Loai
            ...
            For Each dr In dtTongHop.Rows
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        ...
                        TBCHP = diem.dsDiemThi.TBCHP_max
                        Diem_thi_max = diem.dsDiemThi.Diem_thi_max
                        If TBCHP >= 0 And Not Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT Then
                            Tong_diem = (Tong_diem + (TBCHP * Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh))
                            Tong_so_hoc_trinh = (Tong_so_hoc_trinh + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                        End If
                        If diem.dsDiemThiLai.Thi_lai = 1 Then So_mon_thi_lai += 1
                        ...
                        If Diem_thi_max >= 0 And (Diem_thi_max < 5) Then
                            So_mon_no += 1
                            Ten_mon_no = Ten_mon_no & vbCrLf & Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ten_mon & " - " & Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh & " (HS),  " & vbCrLf
                        End If
                        If ((Diem_thi_max >= 0) And Diem_thi_max < 5 And Not Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT) Then
                            So_trinh_no = (So_trinh_no + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh)
                            Ly_thuyet = (Ly_thuyet + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ly_thuyet)
                            Thuc_hanh = (Thuc_hanh + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_hanh)
                            Bai_tap = (Bai_tap + Me.dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Bai_tap)
                ...
                If (So_trinh_no > 0) Then
                    dr.Item("So_trinh_no") = So_trinh_no
                End If
                Tong_tiet = Ly_thuyet + Thuc_hanh
                If (Tong_tiet >= 0) Then
                    dr.Item("Tong_tiet") = Tong_tiet
                End If
                If Ten_mon_no.Length > 0 Then
                    dr.Item("Ten_mon_no") = Ten_mon_no
                End If
            Next
            Return dtTongHop
        End Function
        ...
        Public Function TongHopDiem_XetTotNghiep() As DataTable
            Dim dtTongHop As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_DVHT_CacMon, Tong_DVHT_MonTN, Tong_DVHT_MonLT_Nghe, Tong_DVHT_MonTH_Nghe, Tong_DVHT_Mon_Thuong As Integer
            Dim TBCHP, Diem_thi_max, Tong_Diem_CacMon, Tong_Diem_Mon_TN, Tong_Diem_Mon_Thuong, Tong_Diem_Mon_LT_Nghe, Tong_Diem_Mon_TH_Nghe, TBCHT_Ky As Double
            Dim dr As DataRow
            dtTongHop = mdtDanhSachSinhVien.Copy
            dtTongHop.Columns.Add("TBCHT", GetType(Double))
            dtTongHop.Columns.Add("TBCHT_MonThuong", GetType(Double))
            dtTongHop.Columns.Add("ID_xep_loai", GetType(Integer))
            dtTongHop.Columns.Add("Xep_loai", GetType(String))
            dtTongHop.Columns.Add("So_mon_no", GetType(Integer))
            ...
            dtTongHop.Columns.Add("Diem_toan_khoa", GetType(Double))
            ...
            For Each dr In dtTongHop.Rows
                ...
                Tong_Diem_Mon_LT_Nghe = 0
                Tong_Diem_Mon_TH_Nghe = 0
                ...
                Dim dt_LyDo_mon_batbuoc As DataTable = clsXetTN.Check_MonBatBuoc_SV_List(dr.Item("ID_SV"), mID_dv, 1, dr("Van_hoa"))
                For j As Integer = 0 To dt_LyDo_mon_batbuoc.Rows.Count - 1
                    If LyDo_mon_batbuoc.Trim = "" Then
                        LyDo_mon_batbuoc = dt_LyDo_mon_batbuoc.Rows(j).Item("Ten_mon").ToString.Trim
                    ElseIf dt_LyDo_mon_batbuoc.Rows(j).Item("Ten_mon").ToString.Trim <> "" Then
                        LyDo_mon_batbuoc += ", " & dt_LyDo_mon_batbuoc.Rows(j).Item("Ten_mon")
                    End If
                Next
                'Duyet cac mon hoc
                For i As Integer = 0 To dsMonHoc.Count - 1
                    ...
                    If idx_diem >= 0 Then
                        Dim diem As Diem = arrDiem(idx_diem)
                        TBCHP = Math.Round(diem.dsDiemThi.TBCHP_max, QC.TBCHP_lam_tron)
                        Diem_thi_max = Math.Round(diem.dsDiemThi.Diem_thi_max, QC.TBCHP_lam_tron)
                        'If diem.dsDiemThi.TBCHP_lan(1, 1) < 5 Then So_TC_ThiLai += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                        If diem.dsDiemThi.Diem_thi_lan(1, 1) < 5 Then So_TC_ThiLai += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                        If TBCHP >= 0 Then
                            ...
                            If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT = False Then
                                ...
                                If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = True Then
                                    ...
                                    If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ly_thuyet_nghe = True Then
                                        Tong_DVHT_MonLT_Nghe += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                        Tong_Diem_Mon_LT_Nghe += TBCHP * dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    ElseIf dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Thuc_hanh_nghe = True Then
                                        Tong_DVHT_MonTH_Nghe += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                        Tong_Diem_Mon_TH_Nghe += TBCHP * dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    End If
                                Else
                        ...
                        If Diem_thi_max >= 0 And Diem_thi_max < 5 Then
                            If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = True Then
                                ...
                                If LyDo_no_mon_TN.Trim = "" Then
                                    LyDo_no_mon_TN = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ten_mon & ":" & Math.Round(Diem_thi_max, QC.TBCHP_lam_tron)
                                Else
                                    LyDo_no_mon_TN += ", " & dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ten_mon & ":" & Math.Round(Diem_thi_max, QC.TBCHP_lam_tron)
                                End If
                            Else
                ...
                If Tong_DVHT_CacMon > 0 Then
                    ...
                    dr("TBCHT_MonThuong") = Math.Round((Tong_Diem_CacMon / Tong_DVHT_CacMon) + 0.0000001, 1)
                    dr("So_tin_chi") = Tong_DVHT_CacMon
                    dr("LyDo_MonTN") = LyDo_no_mon_TN
                    dr("Diem_toan_khoa") = (Math.Round((Tong_Diem_Mon_Thuong / Tong_DVHT_Mon_Thuong) + 0.00000001, 1))
        ...
        Function BangDiemSinhVien(ByVal dv As DataView, ByVal ID_dt As Integer) As DataTable
            Dim dt As New DataTable
            Dim dt_tonghop As DataTable
            dt = BangDiemChiTietSinhVien(dv.Item(0)("ID_SV"), ID_dt)
            dt.Columns.Add("Ma_sv", GetType(String))
            dt.Columns.Add("Ho_ten", GetType(String))
            dt.Columns.Add("Ngay_sinh", GetType(Date))
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                dt.Rows(i).Item("Id_he") = dv.Item(0)("Id_he").ToString
        ...
        Private Function TongHopDiemSinhVien(ByVal ID_sv As Integer) As DataTable
            ...
            For i As Integer = 0 To dsMonHoc.Count - 1
                ID_mon = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon
                'Tim diem cua sinh vien nay
                idx_diem = Tim_idx(ID_sv, ID_mon, dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_dt)
                'Nếu sinh viên có điểm môn học này thì tính điểm
                If idx_diem >= 0 Then
                    Dim diem As Diem = arrDiem(idx_diem)
                    TBCHP = diem.dsDiemThi.TBCHP_max
            ...
            Return dtTongHop
        End Function
        Private Function BangDiemChiTietSinhVien(ByVal ID_SV As Integer, ByVal ID_dt As Integer) As DataTable
            Dim dtBangDiem As New DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            dtBangDiem.Columns.Add("Chon", GetType(Boolean))
            ...
            dtBangDiem.Columns.Add("So_tin_chi", GetType(Double))
            dtBangDiem.Columns.Add("TBCHP", GetType(Double))
            dtBangDiem.Columns.Add("TBCHP_Max", GetType(Double))
            dtBangDiem.Columns.Add("TBCHP_HienThi", GetType(Double))
            ...
            For i As Integer = 0 To dsMonHoc.Count - 1
                ...
                ID_mon = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon
                'Tim diem cua sinh vien nay
                idx_diem = Tim_idx(ID_SV, ID_mon, ID_dt)
                'Nếu sinh viên có điểm môn học này thì tính điểm
                ...
                If idx_diem >= 0 AndAlso dtBangDiem.DefaultView.Find(ID_mon) < 0 Then
                    ...
                    dr("TBCMH1") = IIf(diem.dsDiemThi.TBCHP_lan(1, 1) >= 0, Format(Math.Round(diem.dsDiemThi.TBCHP_lan(1, 1) + 0.00000001, QC.TBCHP_lam_tron), "#.0"), "")
                    If dr("TBCMH1") = "" Then dr("TBCMH1") = 0
                    dr("TBCMH2") = IIf(diem.dsDiemThi.TBCHP_lan(1, 2) >= 0, Format(Math.Round(diem.dsDiemThi.TBCHP_lan(1, 2) + 0.00000001, QC.TBCHP_lam_tron), "#.0"), "")
                    ...
                    If diem.dsDiemThi.TBCHP_CoDiemKhacLan1_max() >= 0 Then dr("TBCHP") = Format(Math.Round(diem.dsDiemThi.TBCHP_max + 0.00000001, QC.TBCHP_lam_tron), "#.0")
                    dr("TBCHP_Max") = Format(Math.Round(diem.dsDiemThi.TBCHP_max + 0.00000001, QC.TBCHP_lam_tron), "#.0")
                    If dr("TBCHP").ToString <> "" Then
                        If dr("TBCMH1") < dr("TBCHP") Then dr("TBCHP_HienThi") = dr("TBCHP")
                    End If
        ...
        Public Function Tim_idx(ByVal ID_sv As Integer, ByVal ID_mon As Integer, ByVal ID_dt As Integer) As Integer
            For i As Integer = 0 To arrDiem.Count - 1
                If CType(arrDiem(i), Diem).ID_sv = ID_sv And CType(arrDiem(i), Diem).ID_mon = ID_mon And CType(arrDiem(i), Diem).ID_dt = ID_dt Then
                    Return i
                End If
            Next
            Return -1
            ...
            Try
                For i As Integer = 0 To arrDiem.Count - 1
                    ...
                    Else
                        ...
                        TBCHP = Math.Round(TBCHP, QC.TBCHP_lam_tron)
                        objDiemThi.TBCHP = TBCHP
                        If ((objDiemThi.Diem_thi = -1) And (objDiemThi.Ghi_chu = "")) Then
                            objDiemThi.ID_diem_thi = Delete_DiemThi(ID_diem, Lan_hoc, Lan_thi)
                        ElseIf (Me.CheckExist_svDiemThi(ID_diem, Lan_hoc, Lan_thi) > 0) Then
                            objDiemThi.ID_diem_thi = Update_DiemThi(objDiemThi, ID_diem, Lan_thi)
                        Else
                            objDiemThi.ID_diem_thi = Insert_DiemThi(ID_diem, objDiemThi)
                        End If
                        ''
                        Dim mListDiemThiChiTiet As Generic.List(Of DiemThiChiTiet) = objDiemThi.DiemThiChiTiet
                        For index As Integer = 0 To mListDiemThiChiTiet.Count - 1
                            mListDiemThiChiTiet(index).ID_diem_thi = objDiemThi.ID_diem_thi
                            dsDiemThiChiTiet.UpdateDiemThi(mListDiemThiChiTiet(index))
                        Next
        ...
        Public Function Update_GhiChu_KhongDuDK(ByVal ID_diem As Integer, ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer) As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Update_GhiChu_KhongDuDK(ID_diem, Lan_hoc, Lan_thi)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function Update_GhiChu_NhapHocMuon(ByVal ID_diem As Integer, ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer) As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Update_GhiChu_NhapHocMuon(ID_diem, Lan_hoc, Lan_thi)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Public Function Update_DiemThi_KhongDuDK(ByVal objDiemThi As DiemThi, ByVal ID_diem As Integer, ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer) As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Update_DiemThi_KhongDuDK(objDiemThi, ID_diem, Lan_hoc, Lan_thi)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function Update_DiemThi_NhapHocMuon(ByVal objDiemThi As DiemThi, ByVal ID_diem As Integer, ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer) As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Update_DiemThi_NhapHocMuon(objDiemThi, ID_diem, Lan_hoc, Lan_thi)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function Lock_Diem_Nhanh(Optional ByVal ID_he As Integer = 0, Optional ByVal Khoa_hoc As Integer = 0, Optional ByVal Id_khoa As Integer = 0, Optional ByVal Id_chuyen_nganh As Integer = 0, Optional ByVal Id_lop As Integer = 0, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "") As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Lock_Diem_Nhanh(ID_he, Khoa_hoc, Id_khoa, Id_chuyen_nganh, Id_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function Lock_Diem_TP_Nhanh(Optional ByVal ID_he As Integer = 0, Optional ByVal Khoa_hoc As Integer = 0, Optional ByVal Id_khoa As Integer = 0, Optional ByVal Id_chuyen_nganh As Integer = 0, Optional ByVal Id_lop As Integer = 0, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "") As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Lock_Diem_TP_Nhanh(ID_he, Khoa_hoc, Id_khoa, Id_chuyen_nganh, Id_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function UnLock_Diem_Nhanh(Optional ByVal ID_he As Integer = 0, Optional ByVal Khoa_hoc As Integer = 0, Optional ByVal Id_khoa As Integer = 0, Optional ByVal Id_chuyen_nganh As Integer = 0, Optional ByVal Id_lop As Integer = 0, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "") As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.UnLock_Diem_Nhanh(ID_he, Khoa_hoc, Id_khoa, Id_chuyen_nganh, Id_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function UnLock_Diem_TP_Nhanh(Optional ByVal ID_he As Integer = 0, Optional ByVal Khoa_hoc As Integer = 0, Optional ByVal Id_khoa As Integer = 0, Optional ByVal Id_chuyen_nganh As Integer = 0, Optional ByVal Id_lop As Integer = 0, Optional ByVal Hoc_ky As Integer = 0, Optional ByVal Nam_hoc As String = "") As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.UnLock_Diem_TP_Nhanh(ID_he, Khoa_hoc, Id_khoa, Id_chuyen_nganh, Id_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function DiemSinhVienToanKhoa_Nganh1TrungNganh2(ByVal ID_sv As Integer, ByVal dt_MonTrung As DataTable) As DataTable
            ...
            For i As Integer = 0 To dsMonHoc.Count - 1
                ...
                If dt_MonTrung.DefaultView.Find(dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon) >= 0 Then
                    'ID_mon = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon
                    'Tim diem cua sinh vien nay
                    idx_diem = Tim_idx(ID_sv, dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon, dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_dt)
                    'Nếu sinh viên có điểm môn học này thì tính điểm
                    If idx_diem >= 0 Then
                        Dim diem As Diem = arrDiem(idx_diem)
        ...
        Public Function KetQua_XetLenLop(ByVal dtLop As DataTable, ByVal Nam_hoc As String, ByRef dtHocTiep As DataTable, ByRef dtNgungHoc As DataTable, ByRef dtThoiHoc As DataTable) As DataTable
            Dim idx_diem As Integer, ID_mon As Integer
            Dim Tong_diem As Double, Tong_so_hoc_trinh As Integer
            Dim TBCHP, Tong_tiet_ThoiDiemXet As Double
            Dim dr As DataRow
            ...
            mdtNgungHoc.Columns.Add("Tong_tiet_nam", GetType(Double))
            mdtNgungHoc.Columns.Add("Tong_tiet_no", GetType(Double))
            mdtNgungHoc.Columns.Add("Phan_tram_NH", GetType(String))
            mdtNgungHoc.Columns.Add("Ly_do_NgungHoc", GetType(String))

            mdtThoiHoc = mdtHocTiep.Clone
            mdtThoiHoc.Columns.Add("Tong_tiet_nam", GetType(Double))
            mdtThoiHoc.Columns.Add("Tong_tiet_no", GetType(Double))
            mdtThoiHoc.Columns.Add("Phan_tram_TH", GetType(String))
            mdtThoiHoc.Columns.Add("Ly_do_ThoiHoc", GetType(String))

            Dim Nam As Integer = CType(Left(Nam_hoc, 4), Integer)

            'Gan cac diem chi tiet tung mon hoc cua sinh vien va tinh diem TBCHT, Xep Loai
            For Each dr In mdtDanhSachSinhVien.Rows
                Dim SoHTdiemDuoi5 As Double = 0
                ...
                dt_NamHoc.Columns.Add("Tong_tiet_mon", GetType(Double))
                ...
                dt_LuuDiemNam.Columns.Add("Tong_tiet_mon", GetType(Double))

                Tong_diem = 0
                Tong_so_hoc_trinh = 0
                Tong_tiet_ThoiDiemXet = 0
                        ...
                        If idx_diem >= 0 Then
                            ...
                            If diem.Nam_hoc <= Nam_hoc Then
                                ...
                                If TBCHP >= 0 Then
                                    Tong_diem += TBCHP * dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    Tong_so_hoc_trinh += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    'Tổng tiết tính đến thời điểm xét học vụ
                                    Tong_tiet_ThoiDiemXet += dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Tong_tiet
                                End If
                                ...
                                If TBCHP >= 0 Then
                                    ...
                                    dr_CheckKy("Diem") = TBCHP * dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    dr_CheckKy("So_TC") = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).So_hoc_trinh
                                    dr_CheckKy("Tong_tiet_mon") = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Tong_tiet
                ...
                Dim TongTietNo_ALLNam As Double = 0
                ...
                For j As Integer = 0 To dt_NamHoc.Rows.Count - 1
                    ...
                    For i As Integer = 0 To dt_LuuDiemNam.DefaultView.Count - 1
                        'Tính tổng tiết nợ theo năm
                        Dim TBCHP_nam As Double = Math.Round((dt_LuuDiemNam.DefaultView.Item(i)("Diem") / dt_LuuDiemNam.DefaultView.Item(i)("So_TC")), QC.TBCHP_lam_tron)
                        If TBCHP_nam < 5 Then
                            TongTietNoNam += dt_LuuDiemNam.DefaultView.Item(i)("Tong_tiet_mon")
                        End If
                    ...
                    'Tổng tiết nợ đến thời điểm xét
                    TongTietNo_ALLNam += TongTietNoNam
                ...
                Dim Ly_do1, Ly_do_NgungHoc, Ly_do_ThoiHoc As String
                Ly_do1 = ""
                Ly_do_NgungHoc = ""
                Ly_do_ThoiHoc = ""
                ...
                If TongTietNo_ALLNam > (Tong_tiet_ThoiDiemXet * 0.3) And TongTietNo_ALLNam <= (Tong_tiet_ThoiDiemXet * 0.6) Then Ly_do_NgungHoc = "Có khối lượng môn học không đạt trên 30% đến 60% tổng số giờ của năm học"
                ...
                If TongTietNo_ALLNam > (Tong_tiet_ThoiDiemXet * 0.6) Then Ly_do_ThoiHoc = "Có khối lượng môn học không đạt trên 60% tổng số giờ của năm học"
                '-----------Gan cac ly do vao dt-------------
                'Thoi hoc
                If Ly_do_ThoiHoc.Trim <> "" Then
                    ...
                    dr_thoihoc("Tong_tiet_nam") = Tong_tiet_ThoiDiemXet
                    dr_thoihoc("Tong_tiet_no") = TongTietNo_ALLNam
                    dr_thoihoc("Phan_tram_TH") = Math.Round((TongTietNo_ALLNam / Tong_tiet_ThoiDiemXet) * 100, 1) & "(%)"
                    If Ly_do_ThoiHoc.Trim <> "" Then dr_thoihoc("Ly_do_ThoiHoc") = Ly_do_ThoiHoc
                    mdtThoiHoc.Rows.Add(dr_thoihoc)
                End If
                'Ngung hoc
                If Ly_do_NgungHoc.Trim <> "" Then
                    ...
                    dr_ngunghoc("Tong_tiet_nam") = Tong_tiet_ThoiDiemXet
                    dr_ngunghoc("Tong_tiet_no") = TongTietNo_ALLNam
                    dr_ngunghoc("Phan_tram_NH") = Math.Round((TongTietNo_ALLNam / Tong_tiet_ThoiDiemXet) * 100, 1) & "(%)"
                    If Ly_do_NgungHoc.Trim <> "" Then dr_ngunghoc("Ly_do_NgungHoc") = Ly_do_NgungHoc
                    mdtNgungHoc.Rows.Add(dr_ngunghoc)
                End If
                'Hoc tiep
                If Ly_do1.Trim = "" And Ly_do_NgungHoc.Trim = "" And Ly_do_ThoiHoc.Trim = "" Then
        ...
        Function XetLuanVan(ByVal TBCTL As Double) As DataTable
            ...
            For Each dr In dtTongHop.Rows
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    'Nếu môn này được đưa vào tính điểm thì TBCHT thì mới tính
                    If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = False Then
                        ID_mon = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).ID_mon
                        'Tim diem cua sinh vien nay
                        idx_diem = Tim_idx(dr("ID_sv"), ID_mon, dr("ID_dt"))
                        'idx_diem = Tim_idx(59360, ID_mon, dr("ID_dt"))
                        'Nếu sinh viên có điểm môn học này thì tính điểm
                        If idx_diem >= 0 Then
                            Dim diem As Diem = arrDiem(idx_diem)
                            Dim Thi_max As Double = diem.dsDiemThi.Diem_thi_max
                            TBCHP = diem.dsDiemThi.TBCHP_max
                            If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Khong_tinh_TBCHT = False Then
                                If TBCHP >= 0 Then
                            ...
                            End If
                            'Tính số môn nợ
                            If TBCHP < 5 Or Thi_max < 5 Then
                                If Not dr("Van_hoa") Then
                                    If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Kien_thuc <> 30 Then
                                        So_mon_no += 1
                                    End If
                                Else
                                    So_mon_no += 1
                ...
                Dim dt_check_mon As DataTable = clsXetMon.Check_MonBatBuoc_SV_LuanVan_List(dr("ID_SV"), mID_dv, 0, dr("Van_hoa"))
                'Dim dt_check_mon As DataTable = clsXetMon.Check_MonBatBuoc_SV_LuanVan_List(59360, mID_dv, 0, dr("Van_hoa"))
                Dim Ly_do As String = ""
            ...
            For Each dr In dtTongHop.Rows
                ...
                For i As Integer = 0 To dsMonHoc.Count - 1
                    If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Mon_thi_TN = False Then
                        ...
                        If idx_diem >= 0 Then
                            ...
                            If TBCHP < 5 Or Thi_max < 5 Then
                                If Not dr("Van_hoa") Then
                                    If dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Kien_thuc <> 30 Then ' Nếu là môn chỉ dành cho văn hóa học
                                        So_mon_no += 1
                                        If Ly_do.Trim = "" Then
                                            If TBCHP >= 5 Then
                                                Ly_do = dsMonHoc.ChuongTrinhDaoTaoChiTiet(i).Ten_mon & "(Thi:" & Math.Round(Thi_max, QC.Thi_lam_tron) & ")"
                                            Else
                ...
                For j As Integer = 0 To dt_check_mon.Rows.Count - 1
                    If Ly_do_mon.Trim = "" Then
                        Ly_do_mon = dt_check_mon.Rows(j).Item("Ten_mon").ToString
                    Else
                        Ly_do_mon += ", " & dt_check_mon.Rows(j).Item("Ten_mon").ToString
                    End If
                Next
        ...
        Public Function DanhSachKhongDuDieuKienDuThiHocPhan(ByVal Lan_hoc As Integer, ByVal ID_mon As Integer) As DataTable
            ...
            For r As Integer = dtKDDKThi.Rows.Count - 1 To 0 Step -1
                idx = Tim_idx(dtKDDKThi.Rows(r)("ID_sv"), ID_mon, dtKDDKThi.Rows(r)("ID_dt"))
                If idx >= 0 Then
                    'Lấy 1 Object điểm
                    Dim objDiem As Diem = CType(arrDiem(idx), Diem)
...
#Region "Tổng hợp thi lại, học lại"
        ...
        Function DanhSachThiLaiHocLai(ByVal ID_mon As Integer, ByVal Trang_thai As Integer) As DataTable
            ...
            For i As Integer = 0 To dtTongHop.Rows.Count - 1
                idx_diem = Tim_idx(dtTongHop.Rows(i).Item("ID_sv"), ID_mon, dtTongHop.Rows(i).Item("ID_dt"))
                If idx_diem >= 0 Then
                    Dim diem As Diem = arrDiem(idx_diem)
...
#Region "Cao dang nghe HN"
        ...
        Public Function Load_Diem_Theo_Mon_REPORT_CDN(ByVal dsID_lop As String, ByVal ID_mon As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Load_Diem_Theo_Mon_REPORT_CDN(dsID_lop, ID_mon, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Public Function Load_BANGDIEM_REPORT(ByVal ID_sv As Integer) As DataTable
            Dim obj As Diem_DAL = New Diem_DAL
            Return obj.Load_BANGDIEM_REPORT(ID_sv)
        End Function
        'Cao dang nghe HN
        Public Function Load_ThanhPhan_HocBu(ByVal Lan_hoc As Integer, ByVal ID_lops As String, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_mon As Integer) As DataTable
            Dim obj As Diem_DAL = New Diem_DAL
            Return obj.Load_ThanhPhan_HocBu(Lan_hoc, ID_lops, Hoc_ky, Nam_hoc, ID_mon)
        End Function
        Public Function Load_Diem_thanhPhan_Single(ByVal Lan_hoc As Integer, ByVal ID_lops As String, ByVal ID_thanh_phan As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_mon As Integer) As DataTable
            Dim obj As Diem_DAL = New Diem_DAL
            Return obj.Load_Diem_thanhPhan_Single(Lan_hoc, ID_lops, ID_thanh_phan, Hoc_ky, Nam_hoc, ID_mon)
        End Function
        Public Function Save_DiemKiemTraBu(ByVal id_diem_tp As Integer, ByVal Diem As Single, ByVal Lan_kiem_tra As Integer) As Integer
            Dim obj As Diem_DAL = New Diem_DAL
            If obj.CheckExist_DiemKiemTraBu(id_diem_tp, Lan_kiem_tra) Then
                obj.Update_DiemKiemTraBu(id_diem_tp, Diem, Lan_kiem_tra)
            Else
                obj.Insert_DiemKiemTraBu(id_diem_tp, Diem, Lan_kiem_tra)
            End If
        End Function
        Public Function Load_HocBu(ByVal Lan_hoc As Integer, ByVal ID_lops As String, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_mon As Integer) As DataTable
            Dim obj As Diem_DAL = New Diem_DAL
            Return obj.Load_HocBu(Lan_hoc, ID_lops, Hoc_ky, Nam_hoc, ID_mon)
        ...
        Public Function Insert_HocBu(ByVal id_diem As Integer, ByVal So_tiet_hoc_lt As Integer, ByVal So_tiet_hoc_th As Integer, ByVal Lan_hoc As Integer) As Integer
            Dim dal As New Diem_DAL
            Return dal.Insert_HocBu(id_diem, So_tiet_hoc_lt, So_tiet_hoc_th, Lan_hoc)
        End Function
        Public Function Update_DiemDanh_NEW(ByVal objDiemDanh As DiemDanh, ByVal ID_diem As Integer, ByVal Lan_hoc As Integer) As Integer
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Update_DiemDanh_NEW(objDiemDanh, ID_diem, Lan_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function DanhSachMon_HocLai(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lops As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.DanhSachMon_HocLai(Hoc_ky, Nam_hoc, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lops)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function DanhSachSinhVien_HocLai(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lop As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.DanhSachSinhVien_HocLai(Hoc_ky, Nam_hoc, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lop)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function Mark_TongHopTienHocLai(ByVal Id_Mon As Integer, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lop As String, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Mark_TongHopTienHocLai(Id_Mon, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Function DanhSachSinhVien_ThiLai(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lop As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.DanhSachSinhVien_ThiLai(Hoc_ky, Nam_hoc, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lop)
            Catch ex As Exception
                Throw ex
            End Try
        End Function

        Function MARK_LietKeCacDiemThanhPhan_Load(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.MARK_LietKeCacDiemThanhPhan_Load(Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function Load_DiemTP_TheoSV(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal Id_lop As Integer, ByVal Id_mon As Integer, ByVal Lan_hoc As Integer) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.Load_DiemTP_TheoSV(Hoc_ky, Nam_hoc, Id_lop, Id_mon, Lan_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function TongHop_HocLai(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lops As String, ByRef dt_main As DataTable) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Dim dt As DataTable
                dt = obj.TongHop_HocLai(Hoc_ky, Nam_hoc, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lops)
                dt_main = dt.Copy
                ...
                dt1.Columns.Add("Diem", GetType(Double))
                For i As Integer = 0 To dt.Rows.Count - 1
                    If dt.Rows(i)("Diem") < 5 Then
                        ...
                        If dt1.DefaultView.Count = 0 Then
                            ...
                            dr("Diem") = dt.DefaultView.Item(i)("Diem")
        ...
        Function TongHop_HocLai_Tien(ByVal Hoc_ky As Integer, ByVal Nam_hoc As String, ByVal ID_he As Integer, ByVal Khoa_hoc As Integer, ByVal ID_chuyen_nganh As Integer, ByVal ID_lops As String, ByRef dt_main As DataTable) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Dim dt As DataTable = obj.DanhSachSinhVien_HocLai(Hoc_ky, Nam_hoc, ID_he, Khoa_hoc, ID_chuyen_nganh, ID_lops)
                dt_main = dt.Copy
                Dim dt1 As New DataTable
                dt1.Columns.Add("ID_mon", GetType(Integer))
                dt1.Columns.Add("Ky_hieu", GetType(String))
                ...
                Next
                For i As Integer = 0 To dt1.Rows.Count - 1
                    dt.DefaultView.RowFilter = "ID_mon=" & dt1.Rows(i)("ID_mon")
                    dt1.Rows(i)("So_sv") = dt.DefaultView.Count
                Next
                dt.DefaultView.RowFilter = "1=1"
                dt1.DefaultView.RowFilter = "1=1"
        ...
        Function Load_SinhVien(ByVal dt_main As DataTable, ByVal ID_mon As Integer) As DataTable
            ...
            dt_sv.Columns.Add("Diem", GetType(Double))
            ...
            For i As Integer = 0 To dt.DefaultView.Count - 1
                ...
                dr("Diem") = dt.DefaultView.Item(i)("Diem").ToString
                dt_sv.Rows.Add(dr)
            Next
            dt.DefaultView.RowFilter = "1=1"
        ...
        Function Load_SinhVien_Tien(ByVal dt_main As DataTable, ByVal ID_mon As Integer) As DataTable
            Dim dt As DataTable = dt_main.Copy
            Dim dt_sv As New DataTable
            dt_sv.Columns.Add("Chon", GetType(Boolean))
            dt_sv.Columns.Add("ID_sv", GetType(Integer))
            dt_sv.Columns.Add("Ma_sv", GetType(String))
            dt_sv.Columns.Add("Ho_ten", GetType(String))
            dt_sv.Columns.Add("Ngay_sinh", GetType(Date))
            dt_sv.Columns.Add("Ten_lop", GetType(String))
            dt_sv.Columns.Add("Lan_hoc", GetType(String))
            dt_sv.Columns.Add("Diem_thi", GetType(Double))
            dt_sv.Columns.Add("Ghi_chu", GetType(String))
            dt_sv.Columns.Add("TBCHP", GetType(Double))

            dt.DefaultView.RowFilter = "ID_mon=" & ID_mon
            For i As Integer = 0 To dt.DefaultView.Count - 1
                Dim dr As DataRow
                dr = dt_sv.NewRow
                dr("Chon") = False
                dr("ID_sv") = dt.DefaultView.Item(i)("ID_sv").ToString
                dr("Ma_sv") = dt.DefaultView.Item(i)("Ma_sv").ToString
                dr("Ho_ten") = dt.DefaultView.Item(i)("Ho_ten").ToString
                If dt.DefaultView.Item(i)("Ngay_sinh").ToString <> "" Then dr("Ngay_sinh") = dt.DefaultView.Item(i)("Ngay_sinh")
                dr("Ten_lop") = dt.DefaultView.Item(i)("Ten_lop").ToString
                dr("Lan_hoc") = dt.DefaultView.Item(i)("Lan_hoc").ToString
                dr("Diem_thi") = dt.DefaultView.Item(i)("Diem_thi").ToString
                dr("TBCHP") = dt.DefaultView.Item(i)("TBCHP").ToString
                dr("Ghi_chu") = dt.DefaultView.Item(i)("Ghi_chu").ToString
                dt_sv.Rows.Add(dr)
            Next
            dt.DefaultView.RowFilter = "1=1"
            dt_sv.DefaultView.RowFilter = "1=1"
...
#Region "Tong hop, Thong ke"
        Function dt_DanhSachLop(ByVal ID_khoa As Integer, ByVal Khoa_hoc As Integer) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachLop(ID_khoa, Khoa_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Function dt_DanhSachLop_CoDiem(ByVal ID_he As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachLop_CoDiem(ID_he, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function dt_DanhSachSinhVienLop(ByVal ID_lop As Integer) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachSinhVienLop(ID_lop)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Function dt_DanhSachSinhVienKhoa(ByVal ID_khoa As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachSinhVienKhoa(ID_khoa, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Function dt_DanhSachSinhVienLop_HocKy_NamHoc(ByVal ID_lop As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachSinhVienLop_HocKy_NamHoc(ID_lop, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        Function dt_DanhSachDiemTheoSinhVien(ByVal ID_sv As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachDiemTheoSinhVien(ID_sv, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function dt_DanhSachDiemTheoSinhVien_MonTN(ByVal ID_sv As Integer) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachDiemTheoSinhVien_MonTN(ID_sv)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Function dt_DanhSachDiemTheoSinhVien_TheoNam(ByVal ID_sv As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DanhSachDiemTheoSinhVien_TheoNam(ID_sv, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function dt_DSHocLai(ByVal ID_sv As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DSHocLai(ID_sv, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function dt_DSThiLai(ByVal ID_sv As Integer, ByVal Hoc_ky As Integer, ByVal Nam_hoc As String) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.dt_DSThiLai(ID_sv, Hoc_ky, Nam_hoc)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
        ...
        Public Function DanhSachSinhVien_NoTheoHocPhan(ByVal ID_mon As Integer, ByVal ID_lop As Integer) As DataTable
            Try
                Dim obj As Diem_DAL = New Diem_DAL
                Return obj.DanhSachSinhVien_NoTheoHocPhan(ID_mon, ID_lop)
            Catch ex As Exception
                Throw ex
            End Try
        End Function
