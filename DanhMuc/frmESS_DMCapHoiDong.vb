...
Public Class frmESS_DMCapHoiDong
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục Cấp Hội Đồng"
    Private Const TableName As String = "STU_CapHoiDong"
    Private Const FieldID As String = "ID_cap"
    Private Const FieldMa As String = "Ma_cap"
    Private Const FieldTen As String = "Ten_cap"
    Private Const HeadMa As String = "Mã cấp HD"
    Private Const HeadTen As String = "Tên cấp HD"
...
#Region "Form Event"
    ...
    Private Sub cmdClose_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdClose.Click
        Me.Close()
    End Sub
    Private Sub DataGridViewDM_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs)
