...
Public Class frmESS_DMHocHam
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục Học Hàm Cán Bộ"
    Private Const TableName As String = "STU_HocHam"
    Private Const FieldID As String = "ID_hoc_ham"
    Private Const FieldMa As String = "Ma_hoc_ham"
    Private Const FieldTen As String = "Hoc_ham"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên học hàm"
