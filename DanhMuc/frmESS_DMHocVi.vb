...
Public Class frmESS_DMHocVi
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục Học Vị Cán Bộ"
    Private Const TableName As String = "STU_HocVi"
    Private Const FieldID As String = "ID_hoc_vi"
    Private Const FieldMa As String = "Ma_hoc_vi"
    Private Const FieldTen As String = "Hoc_vi"
    Private Const HeadMa As String = "Ký hiệu"
    Private Const HeadTen As String = "Tên học vị"
