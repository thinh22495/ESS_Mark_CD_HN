...
Public Class frmESS_DMKhoiKienThuc
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục Khối Kiến Thức"
    Private Const TableName As String = "PLAN_ChuongTrinhDaoTaoKienThuc"
    Private Const FieldID As String = "ID_kien_thuc"
    Private Const FieldMa As String = "Ma_kien_thuc"
    Private Const FieldTen As String = "Ten_kien_thuc"
    Private Const FieldTenEn As String = "Ten_kien_thuc_en"
    Private Const HeadMa As String = "Mã kiến thức"
    Private Const HeadTen As String = "Tên kiến thức"
