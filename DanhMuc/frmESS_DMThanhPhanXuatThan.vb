...
Public Class frmESS_DMThanhPhanXuatThan
    Dim add As Boolean = False
    Dim edit As Boolean = False
    Dim loaded As Boolean = False
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục"
    Private Const TableName As String = "STU_ThanhPhanXuatThan"
    Private Const FieldID As String = "ID_thanh_phanh_xuat_than"
    Private Const FieldMa As String = "Ten_thanh_phan"
    Private Const FieldMaEn As String = "Ten_thanh_phan_en"
    Private Const HeadMa As String = "Tên thành phần"
        ...
        Try
            ...
            If add Then
                ...
                If Not CheckExist(ValueMa) Then
                    cls.CatalogueInsert(TableName, FieldMa, ValueMa, FieldMaEn, ValueMaEn)
                    ReloadDataGridView()
                    add = False
                End If
            ElseIf edit Then
                ...
                If ValueMa <> txtMa.Text Then
                    ...
                    If Not CheckExist(txtMa.Text) Then
                        Call GetValueFromUI()
                        cls.CatalogueUpdate(TableName, FieldID, ValueID, FieldMa, ValueMa, FieldMaEn, ValueMaEn)
                        ReloadDataGridView()
                        edit = False
                    End If
                Else
