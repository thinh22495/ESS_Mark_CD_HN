...
#Region "Khai bao Bien & Hang"
    Private Const Header As String = "Danh Mục Loại Xử Lý"
    Private Const TableName As String = "MARK_XuLy"
    Private Const TableParentName As String = "MARK_CapKhenThuongKyLuat"
...
#Region "User Functions"
    ...
    Private Function CheckSelectedGridView() As Boolean
        ...
        If Not rowCurr Is Nothing Then
            ...
            valueMucXuLy = rowCurr.Cells(FieldNameXuLy).Value
            SetValueFromUI()
            Return True
        Else
