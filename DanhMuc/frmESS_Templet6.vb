        ...
        Try
            ...
            If add Then
                ...
                If Not CheckExist(ValueMa) Then
                    cls.CatalogueInsert(TableName, FieldMa, ValueMa, FieldTuDiem, ValueTuDiem, FieldDenDiem, ValueDenDiem)
                    ReloadDataGridView()
                    add = False
                End If
            ElseIf edit Then
                ...
                If ValueMa <> txtMa.Text Then
                    ...
                    If Not CheckExist(txtMa.Text) Then
                        Call GetValueFromUI()
                        cls.CatalogueUpdate(TableName, FieldID, ValueID, FieldMa, ValueMa, FieldTuDiem, ValueTuDiem, FieldDenDiem, ValueDenDiem)
                        ReloadDataGridView()
                        edit = False
                    End If
                Else
