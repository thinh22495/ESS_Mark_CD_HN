    ...
    Private Sub Show_form(ByVal FunctionID As String, ByVal Caption As String)
        Try
            ...
            Select Case FunctionID
                Case 316
                    frmESS_ = New ESS_Mark.frmESS_KhoaDulieuDiemThiTheoPhong
                Case 317
                    frmESS_ = New ESS_Mark.frmESS_KhoaDiemHocPhanDotThi
                Case 318
                    frmESS_ = New ESS_Mark.frmESS_KhoaDuLieuDiemThanhPhanLop
                Case 319
                    frmESS_ = New ESS_Mark.frmESS_KhoaDulieuDiemThiLopHC
                Case 320
                    frmESS_ = New frmESS_ThanhPhanDiem
                Case 321
                    frmESS_ = New ESS_Mark.frmESS_ChangePassword
                Case 322
                    frmESS_ = New ESS_Mark.frmESS_ThamSoQuyChe
                Case 3210
                    frmESS_ = New ESS_Mark.frmESS_DanhSachKhongDuDieuKienDuThiHocPhan
                Case 3211
                ...
                Case 3224
                    frmESS_ = New ESS_Mark.frmESS_BoMon_DanhSach
                Case 3225
                ...
                Case 323
                    frmESS_ = New ESS_Mark.frmESS_ChuongTrinhDaoTaoList
                Case 325
                    frmESS_ = New ESS_Mark.frmESS_ToChucThi_DanhSach
                Case 326
                    frmESS_ = New ESS_Mark.frmESS_DanhSachKhongDuDieuKienDuThiHocPhi
                Case 327
                    frmESS_ = New ESS_Mark.frmESS_ToChucThiDongTui
                Case 328
                    'frmESS_ = New frmESS_TongHopSinhVienThiLai
                    'frmESS_ = New frmTongHopThiLai
                Case 330
                    frmESS_ = New ESS_Mark.frmESS_XetLenLop
                Case 340
                    frmESS_ = New ESS_Mark.frmTongHopSinhVienHocLai
                Case 341
                    frmESS_ = New ESS_Mark.frmTongHopSinhVienHocLai_NopTien
                    'frmTongHopTienHocLai()
                    'frmTongHopSinhVienHocLai_Tien
                    'Case 342
                    '    frmESS_ = New frmTongHopTienThiLai
                Case 329
                    frmESS_ = New ESS_Mark.frmESS_DongTuiThi
                Case 332
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemThanhPhanLop
                Case 333
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemThiLop
                    'Case 334
                    '    frmESS_ = New frmESS_NhapDiemExcel
                Case 335
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemThiPhong
                    'Case 336
                    '    frmESS_ = New frmESS_TongHop_ThiLaiHocLai_DanhSach
                Case 339
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemTuiThi
                Case 3310
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemThiSBD
                Case 3311
                    frmESS_ = New ESS_Mark.frmESS_NhapDiemSoPhach
                Case 353
                    frmESS_ = New ESS_Mark.frmESS_TongHopHocKy
                Case 354 'Tong hop diem theo nam
                    frmESS_ = New ESS_Mark.frmESS_TongHopHocTapNam
                Case 355
                    frmESS_ = New ESS_Mark.frmESS_TongHopHocToanKhoa
                Case 3511
                    frmESS_ = New ESS_Mark.frmESS_TongHopDiemMonMain
                Case 3512
                    frmESS_ = New ESS_Mark.frmESS_BangDiemChiTietSinhVien
                Case 3513
                    frmESS_ = New ESS_Mark.frmESS_TongHopNoChungChi_
                Case 361
                    frmESS_ = New ESS_Mark.frmESS_XetHocTiepThoiHocNgungHoc
                Case 362
                    frmESS_ = New ESS_Mark.frmESS_QuyetDinhThoiHocList
                Case 363
                    frmESS_ = New ESS_Mark.frmESS_XetLuanVanThiTotNghiep
                Case 364
                    frmESS_ = New ESS_Mark.frmESS_PhanCongThucTap
                Case 365
                    frmESS_ = New ESS_Mark.frmESS_NoKhacKhiXetTotNghiep
                Case 366
                    frmESS_ = New ESS_Mark.frmESS_XetTotNghiep
                Case 367
                    frmESS_ = New ESS_Mark.frmESS_TongHopChung
                Case 368
                    frmESS_ = New ESS_Mark.frmESS_InChungChi_List
            End Select
