...
#Region "Property"
        ...
        Public ReadOnly Property Check_hien_thi(ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer) As Boolean
            ...
            End Get
        End Property
        Public ReadOnly Property Check_hien_thi(ByVal Lan_hoc As Integer, ByVal Lan_thi As Integer, ByVal Thi_Cai_Thien As Boolean) As Boolean
            Get
                If Lan_hoc = 1 Then
                    'Chỉ hiển thị những sinh viên thi lại
                    If Lan_thi > 1 Then
