                        ...
                        If Not b(i, j) Then
                            ...
                            If grdVieew.Columns(j).ValueType.Name = "DateTime" Then
                                ...
                                If (grdVieew.Rows(i).Cells(j).Value.ToString() <> "") Then
                                    range1.Value2 = "'" & IIf(CDate(grdVieew.Rows(i).Cells(j).Value).Day < 10, "0" & CDate(grdVieew.Rows(i).Cells(j).Value).Day.ToString, CDate(grdVieew.Rows(i).Cells(j).Value).Day.ToString) & "/" & CDate(grdVieew.Rows(i).Cells(j).Value).Month.ToString & "/" & CDate(grdVieew.Rows(i).Cells(j).Value).Year.ToString
                                End If
                            Else
                    ...
                    For i As Integer = 0 To grdVieew.RowCount - 1
                        If Not b(i, j) Then
                            ...
                            If grdVieew.Columns(j).ColumnType.Name = "DateTime" Then
                                ' Kiểm tra khi cell có giá trị null
                                If (grdVieew.GetDataRow(i)(j).ToString <> "") Then
                                   range1.Value = "'" & IIf(CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Day < 10, "0" & CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Day.ToString, CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Day) & "/" & IIf(CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Month < 10, "0" & CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Month, CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Month) & "/" & CDate(grdVieew.GetDataRow(i)(grdVieew.Columns(j).FieldName)).Year
                                End If
                            Else
                                range1.Value2 = grdVieew.GetDataRow(i)(j)
                            End If
                            range1.WrapText = True
