...
Imports ESS.Library
Public Class frmTongHopSinhVienHocLai1
    ...
    Private Sub cmdTongHop_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdTongHop.Click
        ...
        Try
            ...
            If cmbHoc_ky.Text.Trim <> "" And cmbNam_hoc.Text.Trim <> "" And TreeViewLop_NEW1.ID_he > 0 Then
                ...
                grdViewDanhSachMon.DataSource = clsDiem.TongHop_HocLai(cmbHoc_ky.Text, cmbNam_hoc.Text, ID_he, mKhoa_hoc, mID_chuyen_nganh, mID_lop, dt_main).DefaultView
            End If
        Catch ex As Exception
            Thongbao(ex.Message)
        End Try
    ...
    Private Sub grdViewDanhSachMon_DataSourceChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdViewDanhSachMon.CurrentCellChanged
        Try
            ...
            Try
                ...
                If dv.Count > 0 Then
                    grdViewDanhsachChitiet.DataSource = clsDiem.Load_SinhVien(dt_main, dv.Item(grdViewDanhSachMon.CurrentRow.Index)("ID_mon")).DefaultView
                Else
    ...
    Private Sub cmdPrint_Chitiet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint_Chitiet.Click
        Try
            ...
            If dv.Count > 0 Then
                ...
                Dim tieu_de1 As String = "DSSV HỌC LẠI HỌC MÔN " + dv_mon.Item(grdViewDanhSachMon.CurrentRow.Index)("Ten_mon").ToString.ToUpper + " HỌC KỲ" + cmbHoc_ky.Text + " NĂM HỌC " + cmbNam_hoc.Text
                Dim tieu_de2 As String = TreeViewLop_NEW1.Tieu_de.ToUpper
...
#End Region
    ...
    Private Sub cmbExcel_Click(sender As Object, e As EventArgs) Handles cmbExcel.Click
