...
Imports ESS.Library
Public Class frmTongHopTienThiLai
        ...
        Try
            ...
            Try
                ...
                If dv.Count > 0 Then
                    ...
                    If TreeViewLop_DSMon.ID_chuyen_nganh > 0 Then mID_chuyen_nganh = TreeViewLop_DSMon.ID_chuyen_nganh
                    If TreeViewLop_DSMon.ID_lop > 0 Then mID_lop = TreeViewLop_DSMon.ID_lop
                    dvSinhVien = clsDiem.DanhSachSinhVien_ThiLai(cmbHoc_ky.Text, cmbNam_hoc.Text, ID_he, mKhoa_hoc, mID_chuyen_nganh, mID_lop).DefaultView
